 ...
 * @author SingPC
 */
public class XuatHoaDonTChuyenKhoan extends javax.swing.JFrame {
   private XuatHoaDonRepository hd = new XuatHoaDonRepository();
    ...
    /**
     * Creates new form XuatHoaDonTChuyenKhoan
     */
    public XuatHoaDonTChuyenKhoan() {
        initComponents();
        loadDuLieuu();
...
private ArrayList<DonHangChiTietEntity> layDuLieuTuBang() {
    ...
    tongtien.setText(formatterr.format(tongTien));
    ...
    private void initComponents() {
        ...
        tongtien.setText(" ");
        Email.add(tongtien, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 530, -1, -1));
        ...
        Email.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 560, 80, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Email, javax.swing.GroupLayout.DEFAULT_SIZE, 756, Short.MAX_VALUE)
        );
...
for (DonHangChiTietEntity chiTiet : danhSachChiTiet) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XuatHoaDonTChuyenKhoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XuatHoaDonTChuyenKhoan().setVisible(true);
            }
        });
    }
